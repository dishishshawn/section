...
def verification_code_html(code: str, expiry_minutes: int = 10) -> str:
    """Self-contained HTML email displaying a 6-digit sign-in code."""
    return f"""<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Your Section sign-in code</title>
</head>
        ...
        <table role="presentation" width="560" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;line-height:1.6;color:#4A4A3A;">
                Enter this code in the Section sign-in screen. It expires in
                <strong>{expiry_minutes}&nbsp;minutes</strong>.
              </p>
              <p style="margin:0 0 24px;font-size:34px;font-weight:bold;letter-spacing:0.4em;
                        color:#2C3A1E;font-family:'Courier New',monospace;">
                {code}
              </p>
              <p style="margin:0;font-size:13px;color:#7A7A6A;line-height:1.5;">
                Never share this code. Section will never ask you for it.
              </p>
            </td>
          </tr>
          <tr>
